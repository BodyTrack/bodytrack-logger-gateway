...
public class Transformer
   ...
   public
   static void transform(String in, String out, Filter[] filters) throws FileNotFoundException,
                                                                         IOException,
   ...
   public
   static void transform(String in, String out, Filter filter) throws FileNotFoundException,
                                                                      IOException,
                                                                      UnexpectedFormatException
      {
